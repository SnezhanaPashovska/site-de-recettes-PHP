...
$retriveRecipeWithCommentStatement = $mysqlClient->prepare('SELECT r.*, c.comment_id, c.comment, c.user_id, u.full_name FROM recipes r 
LEFT JOIN comments c on c.recipe_id = r.recipe_id
LEFT JOIN users u ON u.user_id = c.user_id
WHERE r.recipe_id = :id');
$retriveRecipeWithCommentStatement->execute([
  'id'=>(int)$getData['id'],
]);
$recipeWithComments = $retriveRecipeWithCommentStatement->fetchAll(PDO::FETCH_ASSOC);
