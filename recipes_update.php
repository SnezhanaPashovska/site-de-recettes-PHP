...
$retriveRecipeStatement = $mysqlClient->prepare('SELECT * FROM recipes WHERE recipe_id = :id');
$retriveRecipeStatement->execute([
  'id' => (int)$getData['id'],
]);
$recipe = $retriveRecipeStatement->fetch(PDO::FETCH_ASSOC);
